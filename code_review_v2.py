...
# Chave da API OpenAI
openai.api_key = "sk-proj-ExSAbm0B9Rn7w9y4Jkp4T3BlbkFJxYeI4mYSQZ8BQ3l6IyI0"
...
good_practices = {
    "{linguagem_1}": {
        "template": """
        Você é um revisor de código que está auxiliando os desenvolvedores {linguagem_1}.
        ...
        Aqui está minha avaliação do pull request do código {linguagem_1} que foi desenvolvido/alterado:
        {best_practice}
        """
    },
    "{linguagem_2}": {
        "template": """
        Você é um revisor de código que está auxiliando os desenvolvedores {linguagem_2}.
        ...
        Aqui está minha avaliação do pull request do código {linguagem_2} que foi desenvolvido/alterado:
        {best_practice}
        """
    },
    "{linguagem_3}": {
        "template": """
        Você é um revisor de código que está auxiliando os desenvolvedores {linguagem_3}.
        ...
        Aqui está minha avaliação do pull request do código {linguagem_3} que foi desenvolvido/alterado:
        {best_practice}
        """
    }
}
...
def get_pull_requests():
    ...
    if response.status_code == 200:
        ...
        st.error("Erro ao buscar pull requests.")
        return []
...
def get_code_content(url):
    ...
    if response.status_code == 200:
        ...
        st.error("Erro ao buscar o conteúdo do código.")
        return ""
                ...
                with st.expander(f"Pull Request: {pr['titulo']}"):
                    ...
                    for change in pr['alteracoes']:
                        ...
                        if st.button(f"Ver código - {change['arquivo']}"):
                            ...
                            st.code(code_content, language="python")  # Mude o valor de 'language' conforme necessário
        else:
